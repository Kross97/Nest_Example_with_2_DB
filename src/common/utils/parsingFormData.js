...
exports.parsingFormData = void 0;
/**
...
const parseKey = (value) => value
    ...
    .split("=")[1]
    .replace(/"/, "");
const parseFileName = (value) => value
    .match(/filename="[^"]+"/)[0]
    .split("=")[1]
    .replaceAll('"', "");
...
async function parsingFormData(req) {
...
exports.parsingFormData = parsingFormData;
//# sourceMappingURL=parsingFormData.js.map