...
export const UserBlock = () => {
    ...
    return <>
        ...
        <div className={cn.userBlock}>
            <button style={{ marginBottom: '10px'}} onClick={refreshUsers}>рефреш_логинов</button>
            <div style={{padding: '10px', border: '2px solid black', marginBottom: '14px'}}>
                ...
                <h4>Работа с отношениями <br/>1.один-к-одному, <br/>2.многие-ко-многим, <br/>3.один-ко-многим</h4>
                <div className={cn.formUser}>
                    ...
                    <div style={{
                        ...
                        <b>Данный блок задействует создание <u>user</u> полностью через FormData <u>(и его кастомный
                            парсинг
                            на бэке)</u></b>
            ...
            <div className={cn.listUsers}>
                {users?.map((userList) => <div style={{ display: 'flex', flexDirection: 'column', rowGap: '6px'}}>
