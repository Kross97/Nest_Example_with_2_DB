    ...
    <div style={{ display: "flex", columnGap: "10px", whiteSpace: "wrap", wordBreak: "break-all" }}>
      <div data-cyid="crypto_block" className={cn.cryptoBlock}>
        ...
        <div className={cn.blockInfo}>
          <span>
            <b>1. "+$+"</b> - в шифрованном тексте является разделителем между вектором инициализации <b>(iv)</b> и шифруемыми данными
          </span>
          <span>
            <b>2. iv (вектор инициализации)</b> - участвует в шифровании данных, при каждом новом шифровании <b>(Cipher)</b> возвращаемый
            шифр будет отличаться т.к создается новый экземпляр iv (вектора инициализации)
          </span>
          <span>
            <b>3. iv берется из шифра по разделителю</b> - при каждой де-шифрации, что гарантирует корректную работу де-шифрации{" "}
            <b>(Decipher)</b>
          </span>
        </div>
